      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="bg-black/80 backdrop-blur-sm rounded-xl shadow-2xl p-6 mb-8 border border-gray-800">
            <h2 className="text-2xl font-bold text-white mb-4">Детали бронирования</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <div>
                <p className="text-sm text-gray-400">Пассажиры</p>
                <p className="text-lg text-white">{step1Data.adults + step1Data.children} человек</p>
              </div>
              <div>
              ...
              <div>
                <p className="text-sm text-gray-400">Стоимость трансфера</p>
                <p className="text-lg font-semibold text-red-500">${step1Data.price}</p>
              </div>
            </div>
          </div>

          <h1 className="text-3xl font-bold text-white text-center mb-8">Выбор автомобиля</h1>
          <VehicleSelect 
